...
public class PilKomActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    String selectedRB1, selectedRB2, selectedRB3, selectedRB4, selectedRB5, selectedRB6, selectedRB7, selectedRB8, selectedRB9, selectedRB10, selectedRB11, selectedRB12;
    ...
    private void initComponent(){
        ...
        radioGroup10 = findViewById(R.id.rg_p110);
        radioGroup11 = findViewById(R.id.rg_p111);
        radioGroup12 = findViewById(R.id.rg_p112);

        check1 = findViewById(R.id.check_bp01);
        check2 = findViewById(R.id.check_bp02);
        check3 = findViewById(R.id.check_bp03);
        check4 = findViewById(R.id.check_bp04);
        check5 = findViewById(R.id.check_bp05);
    ...
    private void process(){
        ...
        if (selectedRB1.equals("Tidak") && selectedRB2.equals("Tidak") && selectedRB3.equals("Tidak") && selectedRB4.equals("Tidak") && selectedRB5.equals("Tidak") && selectedRB6.equals("Tidak")
            && selectedRB7.equals("Tidak") && selectedRB8.equals("Tidak") && selectedRB9.equals("Tidak") && selectedRB10.equals("Tidak") && selectedRB11.equals("Tidak") && selectedRB12.equals("Tidak")
                && check1.isChecked() && check2.isChecked() && check3.isChecked() && check4.isChecked() && check5.isChecked()){
