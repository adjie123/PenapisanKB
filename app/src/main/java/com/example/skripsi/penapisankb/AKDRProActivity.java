...
public class AKDRProActivity extends AppCompatActivity implements View.OnClickListener{
    private RadioGroup radioGroup1,  radioGroup2,  radioGroup3,  radioGroup4,  radioGroup5,  radioGroup6,  radioGroup7,  radioGroup8,  radioGroup9,  radioGroup10,  radioGroup11,  radioGroup12, radioGroup13,  radioGroup14,  radioGroup15,  radioGroup16;
    private RadioButton rb1, rb2, rb3, rb4, rb5, rb6, rb7, rb8, rb9, rb10, rb11, rb12,  rb13, rb14, rb15, rb16;
    private CheckBox check1, check2, check3, check4;

    String selectedRB1, selectedRB2, selectedRB3, selectedRB4, selectedRB5, selectedRB6, selectedRB7, selectedRB8, selectedRB9, selectedRB10, selectedRB11, selectedRB12, selectedRB13, selectedRB14, selectedRB15, selectedRB16;
    ...
    private void process(){
        ...
        if (selectedRB1.equals("Tidak") && selectedRB2.equals("Tidak") && selectedRB3.equals("Tidak") && selectedRB4.equals("Tidak") && selectedRB5.equals("Tidak") && selectedRB6.equals("Tidak")
                ...
                && check1.isChecked() && check2.isChecked() && check3.isChecked() && check4.isChecked()){
