...
public class SuntikKomActivity extends AppCompatActivity implements View.OnClickListener{
    private RadioGroup radioGroup1,  radioGroup2,  radioGroup3,  radioGroup4,  radioGroup5,  radioGroup6,  radioGroup7,  radioGroup8,  radioGroup9,  radioGroup10, radioGroup11, radioGroup12, radioGroup13, radioGroup14, radioGroup15, radioGroupSK11;
    private RadioButton rb1, rb2, rb3, rb4, rb5, rb6, rb7, rb8, rb9, rb10, rb11, rb12, rb13, rb14, rb15, rbsk11;

    String selectedRB1, selectedRB2, selectedRB3, selectedRB4, selectedRB5, selectedRB6, selectedRB7, selectedRB8, selectedRB9, selectedRB10, selectedRB11, selectedRB12, selectedRB13, selectedRB14 ,selectedRB15, selectedRBSK11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suntik_kom); getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Suntik Kombinasi");
    ...
    private void initComponent(){
        radioGroup1 = findViewById(R.id.rg_sk1);
        radioGroup2 = findViewById(R.id.rg_sk2);
        radioGroup3 = findViewById(R.id.rg_sk3);
        radioGroup4 = findViewById(R.id.rg_sk4);
        radioGroup5 = findViewById(R.id.rg_sk5);
        radioGroup6 = findViewById(R.id.rg_sk6);
        radioGroup7 = findViewById(R.id.rg_sk7);
        radioGroup8 = findViewById(R.id.rg_sk8);
        radioGroup9 = findViewById(R.id.rg_sk9);
        radioGroup10 = findViewById(R.id.rg_sk10);
        radioGroupSK11 = findViewById(R.id.rg_sk11);

        radioGroup11 = findViewById(R.id.rg_bp01);
        radioGroup12 = findViewById(R.id.rg_bp02);
        radioGroup13 = findViewById(R.id.rg_bp03);
        radioGroup14 = findViewById(R.id.rg_bp04);
        radioGroup15 = findViewById(R.id.rg_bp05);
    ...
    private void validasiSatu(){
        ...
        int selectedRG11 =radioGroupSK11.getCheckedRadioButtonId();
        if (selectedRG1 == -1 || selectedRG2 == -1 || selectedRG3 == -1 || selectedRG4 == -1 || selectedRG5 == -1 || selectedRG6 == -1 ||
                selectedRG7 == -1 || selectedRG8 == -1 || selectedRG9 == -1 || selectedRG10 == -1 || selectedRG11 == -1){
            Toast.makeText(SuntikKomActivity.this, "Pilihan masih ada yang kosong", Toast.LENGTH_LONG).show();
        }else{
    ...
    private void validasiDua(){
        ...
        if (selectedRG11 == -1 || selectedRG12 == -1 || selectedRG13 == -1 || selectedRG14 == -1 || selectedRG15 == -1){
            Toast.makeText(SuntikKomActivity.this, "Pilihan masih ada yang kosong", Toast.LENGTH_LONG).show();
        }else{
            process();
        }
    ...
    private void process(){
        ...
        int selectedRG9 = radioGroup9.getCheckedRadioButtonId();
        int selectedRG10 = radioGroup10.getCheckedRadioButtonId();
        int selectedRGSK11 = radioGroupSK11.getCheckedRadioButtonId();
        ...
        if(selectedRGSK11 != -1){
            rbsk11 = findViewById(selectedRGSK11);
            selectedRBSK11 = rbsk11.getText().toString();
        ...
        if (selectedRB1.equals("Tidak") && selectedRB2.equals("Tidak") && selectedRB3.equals("Tidak") && selectedRB4.equals("Tidak") && selectedRB5.equals("Tidak") && selectedRB6.equals("Tidak")
                && selectedRB7.equals("Tidak") && selectedRB8.equals("Tidak") && selectedRB9.equals("Tidak") && selectedRB10.equals("Tidak") && selectedRBSK11.equals("Tidak")
                && selectedRB11.equals("Tidak") && selectedRB12.equals("Tidak") && selectedRB13.equals("Tidak") && selectedRB14.equals("Tidak") && selectedRB15.equals("Tidak")){
            Intent myIntent = new Intent(SuntikKomActivity.this, ResultActivity.class);
            myIntent.putExtra("result", "suntikkom");
            myIntent.putExtra("kelompok", kelompok);
            myIntent.putExtra("alkon", alkon);
            startActivity(myIntent);
            finish();
            //Toast.makeText(this, "Suntik Kombinasi", Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(this, "Tidak dapat menggunakan Suntik Kombinasi", Toast.LENGTH_LONG).show();
        }
    }
