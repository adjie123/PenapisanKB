...
public class SuntikProActivity extends AppCompatActivity implements View.OnClickListener{
    private RadioGroup radioGroup1,  radioGroup2,  radioGroup3,  radioGroup4,  radioGroup5,  radioGroup6,  radioGroup7,  radioGroup8,  radioGroup9,  radioGroup10, radioGroup11, radioGroup12, radioGroup13, radioGroup14, radioGroup15;
    private RadioButton rb1, rb2, rb3, rb4, rb5, rb6, rb7, rb8, rb9, rb10, rb11, rb12, rb13, rb14, rb15;

    String selectedRB1, selectedRB2, selectedRB3, selectedRB4, selectedRB5, selectedRB6, selectedRB7, selectedRB8, selectedRB9, selectedRB10, selectedRB11, selectedRB12, selectedRB13, selectedRB14, selectedRB15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suntik_pro);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Suntik Progestin");
    ...
    private void initComponent(){
        radioGroup1 = findViewById(R.id.rg_sp1);
        radioGroup2 = findViewById(R.id.rg_sp2);
        radioGroup3 = findViewById(R.id.rg_sp3);
        radioGroup4 = findViewById(R.id.rg_sp4);
        radioGroup5 = findViewById(R.id.rg_sp5);
        radioGroup6 = findViewById(R.id.rg_sp6);
        radioGroup7 = findViewById(R.id.rg_sp7);
        radioGroup8 = findViewById(R.id.rg_sp8);
        radioGroup9 = findViewById(R.id.rg_sp9);
        radioGroup10 = findViewById(R.id.rg_sp10);
    ...
    private void validasiSatu(){
        ...
        if (selectedRG1 == -1 || selectedRG2 == -1 || selectedRG3 == -1 || selectedRG4 == -1 || selectedRG5 == -1 || selectedRG6 == -1 ||
            ...
            Toast.makeText(SuntikProActivity.this, "Pilihan masih ada yang kosong", Toast.LENGTH_LONG).show();
        }else{
    ...
    private void process(){
        ...
        if (selectedRB1.equals("Tidak") && selectedRB2.equals("Tidak") && selectedRB3.equals("Tidak") && selectedRB4.equals("Tidak") && selectedRB5.equals("Tidak") && selectedRB6.equals("Tidak")
            ...
            Intent myIntent = new Intent(SuntikProActivity.this, ResultActivity.class);
            myIntent.putExtra("result", "suntikpro");
            myIntent.putExtra("kelompok", kelompok);
            myIntent.putExtra("alkon", alkon);
            startActivity(myIntent);
            finish();
            //Toast.makeText(this, "Suntik Progestin", Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(this, "Tidak dapat menggunakan Suntik Progestin", Toast.LENGTH_LONG).show();
        }
    }
