...
public class PilKomActivity extends AppCompatActivity implements View.OnClickListener{
    private RadioGroup radioGroup1,  radioGroup2,  radioGroup3,  radioGroup4,  radioGroup5,  radioGroup6,  radioGroup7,  radioGroup8,  radioGroup9,  radioGroup10,  radioGroup11,  radioGroup12, radioGroup13, radioGroup14, radioGroupSK11;
    private RadioButton rb1, rb2, rb3, rb4, rb5, rb6, rb7, rb8, rb9, rb10, rb11, rb12, rb13, rb14, rbsk11;

    String selectedRB1, selectedRB2, selectedRB3, selectedRB4, selectedRB5, selectedRB6, selectedRB7, selectedRB8, selectedRB9, selectedRB10, selectedRB11, selectedRB12, selectedRB13, selectedRB14, selectedRBSK11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pil_kom);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Pil Kombinasi");
    ...
    private void initComponent(){
        radioGroup1 = findViewById(R.id.rg_p11);
        radioGroup2 = findViewById(R.id.rg_p12);
        radioGroup3 = findViewById(R.id.rg_p13);
        radioGroup4 = findViewById(R.id.rg_p14);
        radioGroup5 = findViewById(R.id.rg_p15);
        radioGroup6 = findViewById(R.id.rg_p16);
        radioGroup7 = findViewById(R.id.rg_p17);
        radioGroup8 = findViewById(R.id.rg_p18);
        radioGroup9 = findViewById(R.id.rg_p19);
        radioGroupSK11 = findViewById(R.id.rg_p20);

        radioGroup10 = findViewById(R.id.rg_bp01);
        radioGroup11 = findViewById(R.id.rg_bp02);
        radioGroup12 = findViewById(R.id.rg_bp03);
        radioGroup13 = findViewById(R.id.rg_bp04);
        radioGroup14 = findViewById(R.id.rg_bp05);
    ...
    private void validasiSatu(){
        ...
        int selectedRG10 = radioGroupSK11.getCheckedRadioButtonId();
        if (selectedRG1 == -1 || selectedRG2 == -1 || selectedRG3 == -1 || selectedRG4 == -1 || selectedRG5 == -1 || selectedRG6 == -1 ||
            ...
            Toast.makeText(PilKomActivity.this, "Pilihan masih ada yang kosong", Toast.LENGTH_LONG).show();
        }else{
    ...
    private void validasiDua(){
        ...
        if (selectedRG10 == -1 || selectedRG11 == -1 || selectedRG12 == -1 || selectedRG13 == -1 || selectedRG14 == -1){
            Toast.makeText(PilKomActivity.this, "Pilihan masih ada yang kosong", Toast.LENGTH_LONG).show();
        }else{
            process();
        }
    ...
    private void process(){
        ...
        if (selectedRB1.equals("Tidak") && selectedRB2.equals("Tidak") && selectedRB3.equals("Tidak") && selectedRB4.equals("Tidak") && selectedRB5.equals("Tidak") && selectedRB6.equals("Tidak")
            && selectedRB7.equals("Tidak") && selectedRB8.equals("Tidak") && selectedRB9.equals("Tidak") && selectedRB10.equals("Tidak") && selectedRB11.equals("Tidak") && selectedRB12.equals("Tidak")
                && selectedRB13.equals("Tidak") && selectedRB14.equals("Tidak") && selectedRBSK11.equals("Tidak")){
            Intent myIntent = new Intent(PilKomActivity.this, ResultActivity.class);
            myIntent.putExtra("result", "pilkom");
            myIntent.putExtra("kelompok", kelompok);
            myIntent.putExtra("alkon", alkon);
            startActivity(myIntent);
            finish();
            //Toast.makeText(this, "Pil Kombinasi", Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(this, "Tidak dapat menggunakan Pil Kombinasi", Toast.LENGTH_LONG).show();
        }
    }
