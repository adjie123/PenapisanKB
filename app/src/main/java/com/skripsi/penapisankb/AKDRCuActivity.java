...
public class AKDRCuActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_akdrcu);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("AKDR Cu");
    ...
    private void initComponent(){
        radioGroup1 = findViewById(R.id.rg_akdrcu1);
        radioGroup2 = findViewById(R.id.rg_akdrcu2);
        radioGroup3 = findViewById(R.id.rg_akdrcu3);
        radioGroup4 = findViewById(R.id.rg_akdrcu4);
        radioGroup5 = findViewById(R.id.rg_akdrcu5);
        radioGroup6 = findViewById(R.id.rg_akdrcu6);
        radioGroup7 = findViewById(R.id.rg_akdrcu7);
        radioGroup8 = findViewById(R.id.rg_akdrcu8);
        radioGroup9 = findViewById(R.id.rg_akdrcu9);
        radioGroup10 = findViewById(R.id.rg_akdrcu10);
    ...
    private void validasiSatu(){
        ...
        if (selectedRG1 == -1 || selectedRG2 == -1 || selectedRG3 == -1 || selectedRG4 == -1 || selectedRG5 == -1 || selectedRG6 == -1 ||
            ...
            Toast.makeText(AKDRCuActivity.this, "Pilihan masih ada yang kosong", Toast.LENGTH_LONG).show();
        }else{
    ...
    private void process(){
        ...
        if (selectedRB1.equals("Tidak") && selectedRB2.equals("Tidak") && selectedRB3.equals("Tidak") && selectedRB4.equals("Tidak") && selectedRB5.equals("Tidak") && selectedRB6.equals("Tidak")
            ...
            Intent myIntent = new Intent(AKDRCuActivity.this, ResultActivity.class);
            myIntent.putExtra("result", "akdrcu");
            myIntent.putExtra("kelompok", kelompok);
            myIntent.putExtra("alkon", alkon);
            startActivity(myIntent);
            finish();
            //Toast.makeText(this, "AKDR CU", Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(this, "Tidak dapat menggunakan AKDR CU", Toast.LENGTH_LONG).show();
        }
    }
